...
static char __pyx_k_C_Users_Luke_Dropbox_Personal_SS[] = "C:\\Users\\Luke\\Dropbox\\Personal\\SSIM_GITHUB\\custmem.pyx";
...
static PyMethodDef __pyx_mdef_7custmem_1ssim = {"ssim", (PyCFunction)__pyx_pw_7custmem_1ssim, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_7custmem_1ssim(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("ssim (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_arr2in)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("ssim", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_iidim)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ssim", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_macrosize)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ssim", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "ssim") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_iidim = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_iidim == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_macrosize = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_macrosize == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("ssim", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("custmem.ssim", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_arr1in), __pyx_ptype_5numpy_ndarray, 1, "arr1in", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_arr2in), __pyx_ptype_5numpy_ndarray, 1, "arr2in", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_7custmem_ssim(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_arr1in, PyArrayObject *__pyx_v_arr2in, int __pyx_v_iidim, int __pyx_v_macrosize) {
  ...
  __Pyx_TraceCall("ssim", __pyx_f[0], 14);
  ...
  __pyx_pybuffernd_arr2in.rcbuffer = &__pyx_pybuffer_arr2in;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_arr1in.rcbuffer->pybuffer, (PyObject*)__pyx_v_arr1in, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_arr2in.rcbuffer->pybuffer, (PyObject*)__pyx_v_arr2in, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  __pyx_t_3 = 0;
  __pyx_t_4 = 0;
  __pyx_v_arr2ptr = (((&(*__Pyx_BufPtrCContig2d(int *, __pyx_pybuffernd_arr2in.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_arr2in.diminfo[0].strides, __pyx_t_4, __pyx_pybuffernd_arr2in.diminfo[1].strides))) + 1) + __pyx_v_fulldim);
 ...
 */
        ...
        for (__pyx_t_5 = __pyx_v_macrosize; __pyx_t_5 < __pyx_t_12; __pyx_t_5+=1) {
          __pyx_v_i = __pyx_t_5;
 ...
 */
    ...
    __pyx_t_17 = PyFloat_FromDouble((__pyx_v_index / (((double)__pyx_v_iidim) * ((double)__pyx_v_iidim)))); if (unlikely(!__pyx_t_17)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 206; __pyx_clineno = __LINE__; goto __pyx_L25_error;}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("custmem", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
 ...
 * 	cdef double c1 = 6.5025
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7custmem_1ssim, NULL, __pyx_n_s_custmem); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_ssim, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
